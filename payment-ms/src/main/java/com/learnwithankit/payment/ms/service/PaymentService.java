package com.learnwithankit.payment.ms.service;

import com.learnwithankit.payment.ms.dto.CustomerOrder;
import com.learnwithankit.payment.ms.dto.OrderEvent;
import com.learnwithankit.payment.ms.dto.PaymentEvent;
import com.learnwithankit.payment.ms.entity.Payment;
import com.learnwithankit.payment.ms.repository.PaymentRepository;
...
public class PaymentService {
    ...
    public void processPayment(OrderEvent orderEvent){
        ...
        try {
            ...
            repository.save(payment); //real world scenario will have payment logic then save

            paymentProducer.produce(customerOrder, "PAYMENT_CREATED");
//            paymentProducer.produceOrderEvent(customerOrder, "ORDER_COMPLETED");
